...
def openStart():
    ...
    def playGame():
        ...
        '''How to replicated error:
        1. Open instructions window and play a game or
        2. Open empty highscores window and play a game
        ...
        def minusTime():
            ...
            timer_label.place_forget() #Get rid of previous time
            timer_label = Label(window, text=f"{elapsed_time:.2f}", font=("Helvetica", 24), width = 6)
            timer_label.place(x=550, y=10)
