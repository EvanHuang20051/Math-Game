...
def openStart():
    ...
    def playGame():
        ...
        def submit(num, den): # Event = None?
            '''Functions when submitting an answer'''
            def PlayerStep(steps): # With initial steps of 10, moves for a total of 100 units
                if steps != 0:
        ...
        # Bind enter key
        #window = bind("<Return>", lambda:submit(submit_num.get(), submit_den.get()))
        # Finish line graphic
...
def openInstructions():
    ...
    line10 = Label(instructions_window, text="You can press enter to submit rather than pressing the submit button",
                  font=("Helvetica", 12)) #Not true yet, but will implement soon
...
def openHighscores():
    ...
    reset_button.place(x=448, y=524)
...
def startUp():
    ...
    # Start button
    start = Button(window, text = "Start", command = openStart, font = ("Helvetica", 36), padx = 10, pady = 0, anchor = 'w')
    start.place(x=408, y=300)
    # Instructions button
    instructions = Button(window, text = "Instructions", command = openInstructions, font = ("Helvetica", 36), padx = 10, pady = 0, anchor = 'w')
    instructions.place(x=408, y=410)
    # Highscores button
    highscores = Button(window, text = "Highscores", command = openHighscores, font = ("Helvetica", 36), padx = 10, pady = 0, anchor = 'w')
    highscores.place(x=408, y=520)
    # Quit buttons
    quit_button = Button(window, text = "Quit", command = closeProgram, font = ("Helvetica", 36), padx = 10, pady = 0, anchor = 'w')
    quit_button.place(x=408, y=630)
    '''
