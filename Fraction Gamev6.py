...
def submit(submit_num, submit_den):
    ...
    if submit_num == 1 and submit_den == 1:
        print("Correct!")
        number_correct += 1
    else:
        print("Wrong!")
...
def openStart():
    ...
    def playGame():
        ...
        submit_button = Button(window, text = "Submit", command = lambda:submit(int(submit_num.get()), int(submit_den.get())), font = ("Helvetica", 30), padx = 10, pady = 10)
